...
"""
function X1L_Outflow!(U::CuArray{T,4},grid) where T
...
function X1R_Outflow!(U::CuArray{T,4},grid) where T
  # Define the ghost zone index and boundary zone index
  Nghost = grid.Nghost::Int;
...
function X2L_Outflow!(U::CuArray{T,4},grid) where T
  # Define the ghost zone index and boundary zone index
  Nghost = grid.Nghost::Int;
  ghost_Lst,ghost_Led =          1,   Nghost;
  bval_Lst,bval_Led   = Nghost + 1, 2*Nghost;
...
function X2R_Outflow!(U::CuArray{T,4},grid) where T
  # Define the ghost zone index and boundary zone index
  Nghost = grid.Nghost::Int;
  ghost_Rst,ghost_Red =   Nghost - 1, 0;
  bval_Rst,bval_Red   = 2*Nghost - 1, Nghost;
...
function X3L_Outflow!(U::CuArray{T,4},grid) where T
  # Define the ghost zone index and boundary zone index
  Nghost = grid.Nghost::Int;
  ghost_Lst,ghost_Led =          1,   Nghost;
  bval_Lst ,bval_Led  = Nghost + 1, 2*Nghost;
...
function X3R_Outflow!(U::CuArray{T,4},grid) where T
  # Define the ghost zone index and boundary zone index
  Nghost = grid.Nghost::Int;
  ghost_Rst,ghost_Red =   Nghost - 1, 0;
  bval_Rst,bval_Red   = 2*Nghost - 1, Nghost;
...
function X2R_Outflow_MPI!(U,grid)
  X2R_Outflow!(U::CuArray{T,4},grid) where T;
...
function X3L_Outflow_MPI!(U,grid)
  ...
  X3L_Outflow!(U::CuArray{T,4},grid) where T;
...
function X3R_Outflow_MPI!(U,grid)
  X3R_Outflow!(U::CuArray{T,4},grid) where T;
